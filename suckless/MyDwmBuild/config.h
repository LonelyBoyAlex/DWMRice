...
static const char *volup[]   = { "sh", "-c", "pactl set-sink-volume @DEFAULT_SINK@ +5% && kill -SIGRTMIN+2 $(pidof dwmblocks)", NULL };
static const char *voldown[] = { "sh", "-c", "pactl set-sink-volume @DEFAULT_SINK@ -5% && kill -SIGRTMIN+2 $(pidof dwmblocks)", NULL };
static const char *volmute[] = { "sh", "-c", "pactl set-sink-mute @DEFAULT_SINK@ toggle && kill -SIGRTMIN+2 $(pidof dwmblocks)", NULL };
static const char *blup[]   = { "sh", "-c", "brightnessctl set 5%+ && kill -SIGRTMIN+6 $(pidof dwmblocks)", NULL };
static const char *bldown[] = { "sh", "-c", "brightnessctl set 5%- && kill -SIGRTMIN+6 $(pidof dwmblocks)", NULL };
...
static char normbgcolor[]                = "#1e1e2e"; // Mocha - Base
static char normbordercolor[]            = "#313244"; // Mocha - Surface0
static char normfloatcolor[]             = "#89b4fa"; // Mocha - Blue
static char selfgcolor[]                 = "#1e1e2e"; // Mocha - Base (fg on highlight)
static char selbgcolor[]                 = "#cba6f7"; // Mocha - Mauve (highlight)
static char selbordercolor[]             = "#cba6f7"; // Mocha - Mauve (highlight)
static char selfloatcolor[]              = "#cba6f7"; // Mocha - Mauve (highlight)
static char titlenormfgcolor[]           = "#cdd6f4"; // Mocha - Text
static char titlenormbgcolor[]           = "#1e1e2e"; // Mocha - Base
static char titlenormbordercolor[]       = "#313244"; // Mocha - Surface0
static char titlenormfloatcolor[]        = "#89b4fa"; // Mocha - Blue
static char titleselfgcolor[]            = "#1e1e2e"; // Mocha - Base (fg on highlight)
static char titleselbgcolor[]            = "#cba6f7"; // Mocha - Mauve (highlight)
static char titleselbordercolor[]        = "#cba6f7"; // Mocha - Mauve (highlight)
static char titleselfloatcolor[]         = "#cba6f7"; // Mocha - Mauve (highlight)
static char tagsnormfgcolor[]            = "#cdd6f4"; // Mocha - Text
static char tagsnormbgcolor[]            = "#1e1e2e"; // Mocha - Base
static char tagsnormbordercolor[]        = "#313244"; // Mocha - Surface0
static char tagsnormfloatcolor[]         = "#89b4fa"; // Mocha - Blue
static char tagsselfgcolor[]             = "#1e1e2e"; // Mocha - Base (fg on highlight)
static char tagsselbgcolor[]             = "#cba6f7"; // Mocha - Mauve (highlight)
static char tagsselbordercolor[]         = "#cba6f7"; // Mocha - Mauve (highlight)
static char tagsselfloatcolor[]          = "#cba6f7"; // Mocha - Mauve (highlight)
static char hidnormfgcolor[]             = "#585b70"; // Mocha - Surface2 (dimmed)
static char hidselfgcolor[]              = "#cba6f7"; // Mocha - Mauve (highlight)
static char hidnormbgcolor[]             = "#1e1e2e"; // Mocha - Base
static char hidselbgcolor[]              = "#1e1e2e"; // Mocha - Base
static char urgfgcolor[]                 = "#cdd6f4"; // Mocha - Text
static char urgbgcolor[]                 = "#1e1e2e"; // Mocha - Base
static char urgbordercolor[]             = "#f38ba8"; // Mocha - Red (urgent)
static char urgfloatcolor[]              = "#f38ba8"; // Mocha - Red (urgent)
...
static const unsigned int borderTalpha = 0x33;
static const unsigned int alphas[][3] = {
  /*                       fg      bg        border     */
  [SchemeNorm]         = { OPAQUE, baralpha, borderTalpha },
...
static const Launcher launchers[] = {
  ...
  { "    ",               CMD("rofi", "-show", "drun", "-config", "~/DWMScr/config.rasi") },
};
...
{ MODKEY|SUPKEY|ShiftMask,    KEY,      swaptags,       {.ui = 1 << TAG} }, \
{ MODKEY|SUPKEY,              KEY,      tagnextmon,     {.ui = 1 << TAG} }, \
{ MODKEY|SUPKEY|ControlMask,  KEY,      tagprevmon,     {.ui = 1 << TAG} },
...
static const Key keys[] = {
  ...
  { MODKEY, XK_BackSpace, spawn, SHCMD("$HOME/DWMScr/dmenu.sh powermenu") },
  { MODKEY|ShiftMask, XK_s, spawn, SHCMD("$HOME/DWMScr/dmenu.sh screenshot") },
  { SUPKEY|ControlMask, XK_s, spawn, SHCMD("$HOME/DWMScr/dmenu.sh screenshot") },
  { SUPKEY|ControlMask, XK_w, spawn, SHCMD("$HOME/DWMScr/wallpaper.sh choose") },
  { MODKEY, XK_w, spawn, SHCMD("$HOME/DWMScr/wallpaper.sh") },
  { MODKEY|ShiftMask, XK_l, spawn, SHCMD("betterlockscreen -l blur -q") },
  { MODKEY|ShiftMask, XK_w, spawn, SHCMD("$HOME/DWMScr/wallpaperd.sh choose") },
  { SUPKEY, XK_u, spawn, SHCMD("$HOME/DWMScr/blocks.sh") },
  { SUPKEY, XK_space, spawn, SHCMD("$HOME/DWMScr/dmenu.sh launcher") },
//{ SUPKEY, XK_space, spawn, SHCMD("j4-dmenu-desktop --dmenu='dmenu -i -fn \"Iosevka Nerd Font:size=15\" -nb \"#1e1e2e\" -nf \"#cdd6f4\" -sb \"#cba6f7\" -sf \"#1e1e2e\" -p \" Apps:\"'") },
  ...
  STACKKEYS(MODKEY,                              focus)
    ...
    { MODKEY|SUPKEY,              XK_j,          rotatestack,            {.i = +1 } },
    { MODKEY|SUPKEY,              XK_k,          rotatestack,            {.i = -1 } },
#endif // ROTATESTACK_PATCH
#if INPLACEROTATE_PATCH
    { MODKEY|SUPKEY,              XK_j,          inplacerotate,          {.i = +2 } }, // same as rotatestack
    { MODKEY|SUPKEY,              XK_k,          inplacerotate,          {.i = -2 } }, // same as reotatestack
    { MODKEY|SUPKEY|ShiftMask,    XK_j,          inplacerotate,          {.i = +1} },
    { MODKEY|SUPKEY|ShiftMask,    XK_k,          inplacerotate,          {.i = -1} },
...
#if MOVERESIZE_PATCH
    { MODKEY|SUPKEY,              XK_Down,       moveresize,             {.v = "0x 25y 0w 0h" } },
    { MODKEY|SUPKEY,              XK_Up,         moveresize,             {.v = "0x -25y 0w 0h" } },
    { MODKEY|SUPKEY,              XK_Right,      moveresize,             {.v = "25x 0y 0w 0h" } },
    { MODKEY|SUPKEY,              XK_Left,       moveresize,             {.v = "-25x 0y 0w 0h" } },
    { MODKEY|SUPKEY|ShiftMask,    XK_Down,       moveresize,             {.v = "0x 0y 0w 25h" } },
    { MODKEY|SUPKEY|ShiftMask,    XK_Up,         moveresize,             {.v = "0x 0y 0w -25h" } },
    { MODKEY|SUPKEY|ShiftMask,    XK_Right,      moveresize,             {.v = "0x 0y 25w 0h" } },
    { MODKEY|SUPKEY|ShiftMask,    XK_Left,       moveresize,             {.v = "0x 0y -25w 0h" } },
    ...
    { MODKEY|SUPKEY,              XK_Tab,        shiftviewclients,       { .i = -1 } },
    { MODKEY|SUPKEY,              XK_backslash,  shiftviewclients,       { .i = +1 } },
    ...
    { MODKEY|SUPKEY|ShiftMask,    XK_Left,       shiftswaptags,          { .i = -1 } },
    { MODKEY|SUPKEY|ShiftMask,    XK_Right,      shiftswaptags,          { .i = +1 } },
    ...
    { MODKEY|SUPKEY,              XK_space,      unfloatvisible,         {0} },
    ...
    { MODKEY|ControlMask,             XK_bracketleft,       tagtoleft,              {0} }, // note keybinding conflict with shifttag
    { MODKEY|ControlMask,             XK_bracketright,      tagtoright,             {0} }, // note keybinding conflict with shifttag
    { MODKEY|ShiftMask,           XK_bracketleft,       tagandviewtoleft,       {0} }, // note keybinding conflict with placedir
    { MODKEY|ShiftMask,           XK_bracketright,      tagandviewtoright,      {0} }, // note keybinding conflict with placedir
...
#endif // TAGALL_PATCH
#if TAGALLMON_PATCH
    { MODKEY|SUPKEY|ShiftMask,    XK_comma,      tagallmon,              {.i = +1 } },
    { MODKEY|SUPKEY|ShiftMask,    XK_period,     tagallmon,              {.i = -1 } },
#endif // TAGALLMON_PATCH
#if TAGSWAPMON_PATCH
    { MODKEY|SUPKEY|ControlMask,  XK_comma,      tagswapmon,             {.i = +1 } },
    { MODKEY|SUPKEY|ControlMask,  XK_period,     tagswapmon,             {.i = -1 } },
    ...
    { MODKEY|ControlMask|ShiftMask,           XK_numbersign, setborderpx,            {.i = 0 } },
