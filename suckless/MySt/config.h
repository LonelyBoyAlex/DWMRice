 ...
 */
static char *font = "JetBrainsMono Nerd Font Propo:pixelsize=20:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
...
float stat_alpha = 0.4; //constant alpha value that'll get added to grad_alpha
...
static const char *colorname[] = {
	...
	/* special (KEEP YOUR INDEX ORDER) */
	"#f5e0dc", /* 256 -> cursor */
	"#11111b", /* 257 -> reverse cursor */
	"#1e1e2e", /* 258 -> bg */
	"#cdd6f4", /* 259 -> fg */
};
